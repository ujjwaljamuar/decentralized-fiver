...
export const Appbar = () => {
    ...
    //     setBalance(response.data.pendingAmount/ 1000000);
    // }
    ...
    useEffect(() => {
        ...
        // const response = axios.get(`${BACKEND_URL}/v1/worker/balance`, {
        //     headers: {
        //         Authorization: localStorage.getItem("token"),
        //     },
        // });
    ...
    return (
        <div className="flex justify-between border-b pb-2 pt-2">
            <div className="text-2xl pl-4 flex justify-center pt-2">Tlabll</div>
